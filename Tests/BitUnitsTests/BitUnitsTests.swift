...
class BitUnitsTests: XCTestCase {
    ...
    func testBitConversions() {
        for i: UInt64 in 0 ... 999 {
            ...
            XCTAssertEqual(i / 1_000_000, BitUnit.convert(i, from: .Bit, to: .Megabit))
            XCTAssertEqual(i / 1_000_000_000, BitUnit.convert(i, from: .Bit, to: .Gigabit))
            XCTAssertEqual(i / 1_000_000_000_000, BitUnit.convert(i, from: .Bit, to: .Terabit))
            XCTAssertEqual(i / 1_000_000_000_000_000, BitUnit.convert(i, from: .Bit, to: .Petabit))
            ...
            XCTAssertEqual(i / 1_000_000, BitUnit.convert(i, from: .Kilobit, to: .Gigabit))
            XCTAssertEqual(i / 1_000_000_000, BitUnit.convert(i, from: .Kilobit, to: .Terabit))
            XCTAssertEqual(i / 1_000_000_000_000, BitUnit.convert(i, from: .Kilobit, to: .Petabit))

            XCTAssertEqual(i * 125_000, BitUnit.convert(i, from: .Megabit, to: .Byte))
            XCTAssertEqual(i * 1_000_000, BitUnit.convert(i, from: .Megabit, to: .Bit))
            ...
            XCTAssertEqual(i / 1_000_000, BitUnit.convert(i, from: .Megabit, to: .Terabit))
            XCTAssertEqual(i / 1_000_000_000, BitUnit.convert(i, from: .Megabit, to: .Petabit))

            XCTAssertEqual(i * 125_000_000, BitUnit.convert(i, from: .Gigabit, to: .Byte))
            XCTAssertEqual(i * 1_000_000_000, BitUnit.convert(i, from: .Gigabit, to: .Bit))
            XCTAssertEqual(i * 1_000_000, BitUnit.convert(i, from: .Gigabit, to: .Kilobit))
            ...
            XCTAssertEqual(i / 1_000_000, BitUnit.convert(i, from: .Gigabit, to: .Petabit))

            XCTAssertEqual(i * 125_000_000_000, BitUnit.convert(i, from: .Terabit, to: .Byte))
            XCTAssertEqual(i * 1_000_000_000_000, BitUnit.convert(i, from: .Terabit, to: .Bit))
            XCTAssertEqual(i * 1_000_000_000, BitUnit.convert(i, from: .Terabit, to: .Kilobit))
            XCTAssertEqual(i * 1_000_000, BitUnit.convert(i, from: .Terabit, to: .Megabit))
            ...
            XCTAssertEqual(i * 125_000_000_000_000, BitUnit.convert(i, from: .Petabit, to: .Byte))
            XCTAssertEqual(i * 1_000_000_000_000_000, BitUnit.convert(i, from: .Petabit, to: .Bit))
            XCTAssertEqual(i * 1_000_000_000_000, BitUnit.convert(i, from: .Petabit, to: .Kilobit))
            XCTAssertEqual(i * 1_000_000_000, BitUnit.convert(i, from: .Petabit, to: .Megabit))
            XCTAssertEqual(i * 1_000_000, BitUnit.convert(i, from: .Petabit, to: .Gigabit))
    ...
    func testBinaryConversions() {
        for i: UInt64 in 0 ... 999 {
            ...
            XCTAssertEqual(i / 1_048_576, BitUnit.convert(i, from: .Byte, to: .Mebibyte))
            XCTAssertEqual(i / 1_073_741_824, BitUnit.convert(i, from: .Byte, to: .Gibibyte))
            XCTAssertEqual(i / 1_099_511_627_776, BitUnit.convert(i, from: .Byte, to: .Tebibyte))
            XCTAssertEqual(i / 1_125_899_906_842_624, BitUnit.convert(i, from: .Byte, to: .Pebibyte))
            ...
            XCTAssertEqual(i / 1_048_576, BitUnit.convert(i, from: .Kibibyte, to: .Gibibyte))
            XCTAssertEqual(i / 1_073_741_824, BitUnit.convert(i, from: .Kibibyte, to: .Tebibyte))
            XCTAssertEqual(i / 1_099_511_627_776, BitUnit.convert(i, from: .Kibibyte, to: .Pebibyte))

            XCTAssertEqual(i * 1_048_576, BitUnit.convert(i, from: .Mebibyte, to: .Byte))
            ...
            XCTAssertEqual(i / 1_048_576, BitUnit.convert(i, from: .Mebibyte, to: .Tebibyte))
            XCTAssertEqual(i / 1_073_741_824, BitUnit.convert(i, from: .Mebibyte, to: .Pebibyte))

            XCTAssertEqual(i * 1_073_741_824, BitUnit.convert(i, from: .Gibibyte, to: .Byte))
            XCTAssertEqual(i * 1_048_576, BitUnit.convert(i, from: .Gibibyte, to: .Kibibyte))
            ...
            XCTAssertEqual(i / 1_048_576, BitUnit.convert(i, from: .Gibibyte, to: .Pebibyte))

            XCTAssertEqual(i * 1_099_511_627_776, BitUnit.convert(i, from: .Tebibyte, to: .Byte))
            XCTAssertEqual(i * 1_073_741_824, BitUnit.convert(i, from: .Tebibyte, to: .Kibibyte))
            XCTAssertEqual(i * 1_048_576, BitUnit.convert(i, from: .Tebibyte, to: .Mebibyte))
            ...
            XCTAssertEqual(i * 1_125_899_906_842_624, BitUnit.convert(i, from: .Pebibyte, to: .Byte))
            XCTAssertEqual(i * 1_099_511_627_776, BitUnit.convert(i, from: .Pebibyte, to: .Kibibyte))
            XCTAssertEqual(i * 1_073_741_824, BitUnit.convert(i, from: .Pebibyte, to: .Mebibyte))
            XCTAssertEqual(i * 1_048_576, BitUnit.convert(i, from: .Pebibyte, to: .Gibibyte))
